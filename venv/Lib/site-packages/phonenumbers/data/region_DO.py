...
PHONE_METADATA_DO = PhoneMetadata(id='DO', country_code=1, international_prefix='011',
    ...
    toll_free=PhoneNumberDesc(national_number_pattern='800(?:14|[2-9]\\d)\\d{5}|8[024]9[01]\\d{6}|8(?:33|44|55|66|77|88)[2-9]\\d{6}', example_number='8002123456', possible_length=(10,)),
